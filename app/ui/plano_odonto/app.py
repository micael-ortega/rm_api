...
class OdontoApp(ttk.Frame):
    def __init__(self, master: tk.Misc | None = None) -> None:
        ...
        if master is None:
            master = tk.Tk()
        self.master = master
        self.master.title("Gerador TXT Odontologico")
        self._build_menu()
    ...
    def _build_widgets(self) -> None:
        ...
        ttk.Label(filtro_frame, text="Nome contem:").grid(row=0, column=0, sticky="w")
        ...
        ttk.Label(filtro_frame, text="Assistencia Odontológica ativa:").grid(
        ...
        self.combo_flag.grid(row=4, column=1, columnspan=2, sticky="we", pady=4)
        ...
        ).grid(row=5, column=2, pady=6, sticky="e")
    ...
    def _on_adicionar(self) -> None:
        ...
        if idx_dep < 0 or idx_plano < 0:
            messagebox.showwarning("Selecao incompleta", "Selecione dependente e plano.")
            return
        if idx_flag < 0:
            messagebox.showwarning("Selecao incompleta", "Selecione o status da assistencia.")
            return
